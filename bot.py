...
with open('./config/configs.json', 'r') as config_file:
...
robot = bot.TelegramClient("CodeNexis-UniStreamXtract_Dev", API_ID, API_HASH)
...
# Database setup
conn_users = sqlite3.connect('./UniStreamXtract_Ultimate_Client_Details.db')
